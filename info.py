...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb://devashi624:devashi624@<hostname>/?ssl=true&replicaSet=atlas-u831pi-shard-0&authSource=admin&retryWrites=true&w=majority")
