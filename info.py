...
BOT_TOKEN = environ.get('BOT_TOKEN', "7883114092:AAE412ghnpqBM2UHCw7Y9uKWebs1Xz7MOr8")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6859451629 1497525769 7750976141 5657118987 7858727461').split()]
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002374007942') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002374007942') # request channel id ( make sure bot is admin )
...
# HOWTOVERIFY = environ.get('HOWTOVERIFY', url='de20394ac3c17f42a2a636168dd67df9820047c9') 
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002374007942').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002374007942')) #Log channel id ( make sure bot is admin )
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL','-1002409302148'))
...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002374007942'))
