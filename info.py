...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002263775492') # support group id ( make sure bot is admin )
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002263775492') # request channel id ( make sure bot is admin )
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002263775492').split()]
